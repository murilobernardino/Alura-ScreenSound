...
public class ScreenSoundContext : IdentityDbContext<PessoaComAcesso, PerfilDeAcesso, int>
{
    ...
    public DbSet<AvaliacaoArtista> AvaliacaoArtistas{ get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) // Configurações adicionais do modelo
    {
        ...
        modelBuilder.Entity<AvaliacaoArtista>()
            .HasKey(a => new {a.ArtistaId, a.PessoaId}); // Configuração da chave primária composta para AvaliaçãoArtista
    }
}